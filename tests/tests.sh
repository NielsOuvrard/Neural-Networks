...
layers=( "64 10 10 10 1" "64 22 22 22 1" "64 64 64 64 1" )
...
echo "Architecture,LearningRate,Epochs,Accuracy" > "$csv_file"
...
for layer in "${layers[@]}"; do
    for epoch in "${epochs[@]}"; do
        for learning_rate in "${learning_rates[@]}"; do
            ...
            echo "Training & Testing : $layer - $epoch - $learning_rate"
            ...
            echo "$layer,$epoch,$learning_rate,$average_accuracy" >> "$csv_file"
...
echo "Best Epochs: $best_epoch"
echo "Best Learning Rate: $best_learning_rate"
